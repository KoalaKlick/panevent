    ...
    return (
        <section className="relative min-h-screen w-full bg-[url(/landing/g.webp)] bg-cover bg-center bg-no-repeat bg-fixed">
            ...
            <div className="flex min-h-screen items-stretch">
                ...
                <div className="w-full max-w-6xl z-10 relative bg-black backdrop-blur-md flex items-center justify-center px-4 py-20">
...
{/* Hero image with split effect - grayscale left, color right */}
                ...
                <div className="flex-1 backdrop-grayscale z-0 bg-amber-100/5" />
            </div>
        </section>
    )
}